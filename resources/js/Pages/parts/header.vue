                ...
                <div class="flex relative inline-block float-right">
                    ...
                    <div class="relative text-sm">
                        <button id="userButton" class="flex items-center focus:outline-none mr-3">
                            <span class="w-8 h-8 rounded-full mr-4 fa-2x fa-fw text-gray-200 fa fa-user"></span> 
                ...
                <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                    <li class="mr-6 my-2 md:my-0">
                        <inertia-link href="/#" :class="active('/#')">
                            <i class="fas fa-home fa-fw mr-3 text-primary"></i><span class="pb-1 md:pb-0 text-sm">Home</span>
                        </inertia-link>
                    </li>
                    <li class="mr-6 my-2 md:my-0">
                        <inertia-link href="/company" :class="active('/company')">
                            <i class="fas fa-tasks fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Company</span>
                        </inertia-link>
                    </li>
                    <li class="mr-6 my-2 md:my-0">
                        <inertia-link href="/places" :class="active('/places')">
                            <i class="fas fa-tasks fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Depos</span>
                        </inertia-link>
                    </li>
                    <li class="mr-6 my-2 md:my-0">
                        <inertia-link href="/users" :class="active('/users')">
                    ...
                    <li class="mr-6 my-2 md:my-0">
                        <inertia-link href="/logout" :class="active('#')">
                            <i class="fa fa-wallet fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Logout</span>
                        </inertia-link>
                    </li>
                </ul>
