                ...
                <div class="bg-white border rounded shadow">
                    <div class="border-b p-3">
                        <h5 class="font-bold uppercase text-gray-600">
                            USER LIST
                            <span v-on:click="toggleModal()" class=" p-3 text-green-400 hover:text-green-600 hover:font-medium fa fa-plus float-right cursor-pointer"> Add </span>
                        </h5>
                    </div>
                    <div class="p-2">
                        ...
                        <table class="w-full flex flex-row flex-no-wrap sm:bg-white rounded overflow-hidden sm:shadow-lg my-5">
                            <thead class="text-white">
                                <tr  v-for="(user, index) in users.data" v-bind:key="index" class="bg-green-400 flex flex-col flex-no wrap sm:table-row rounded-l-lg sm:rounded-none mb-2 sm:mb-0">
